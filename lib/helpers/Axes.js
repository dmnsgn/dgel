...
import { GPUIndexFormat, GPUPrimitiveTopology } from "../constants.js"; // prettier-ignore
...
0, 0, 1,
/* color */
0.5, 0.5, 1, 1]); // prettier-ignore

const indices = new Uint16Array([0, 1, 2, 3, 4, 5]);

class Axes {
  constructor(systemBindGroupLayout, systemUniformBindGroup) {
