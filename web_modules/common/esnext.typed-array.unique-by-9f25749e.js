import { w as wellKnownSymbol, g as global_1, o as objectGetPrototypeOf, u as uid, c as createNonEnumerableProperty, i as isCallable, d as descriptors, h as hasOwnProperty_1, a as isObject, b as objectDefineProperty, t as tryToString, r as redefine, f as fails, e as toIntegerOrInfinity, j as toLength, k as toObject, l as lengthOfArrayLike, m as toAbsoluteIndex, n as objectGetOwnPropertyNames, p as functionName, q as internalState, s as classofRaw, v as indexedObject, x as getBuiltIn, y as createCommonjsModule, _ as _export, z as objectCreate, A as toPropertyKey, B as isSymbol, C as createPropertyDescriptor, D as objectGetOwnPropertyDescriptor, E as engineUserAgent, F as aCallable, G as engineV8Version } from './iterators-4444ce54.js';
import { r as redefineAll, a as aConstructor, i as isConstructor, s as speciesConstructor } from './species-constructor-11855128.js';
import { c as classof, a as anInstance, g as getIteratorMethod, i as isArrayIteratorMethod, b as getIterator, f as functionBindContext } from './function-bind-context-55fe7978.js';
import { o as objectSetPrototypeOf, s as setToStringTag } from './set-to-string-tag-7a1a0721.js';
...
// https://github.com/tc39/proposal-array-unique
exportTypedArrayMethod$5('uniqueBy', function uniqueBy(resolver) {
  return typedArrayFromSpeciesAndList(this, arrayUniqueBy.call(aTypedArray$5(this), resolver));
});
