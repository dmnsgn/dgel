import { t as toString_1 } from './common/es.error.cause-203e70ef.js';
import './common/esnext.iterator.filter-123a03ed.js';
import { a as iterators, i as iterate } from './common/iterate-7440955a.js';
import './common/esnext.iterator.for-each-25f5ed2e.js';
import './common/esnext.iterator.reduce-f8940db8.js';
import './common/esnext.iterator.map-75a9bbfe.js';
import { _ as _export, a as iteratorClose, g as getIteratorDirect } from './common/iterator-close-ed3256eb.js';
import { j as functionUncurryThis, w as wellKnownSymbol, D as isNullOrUndefined, m as hasOwnProperty_1, e as classof, l as getBuiltIn, c as isObject, i as isCallable, x as toIntegerOrInfinity, G as aCallable, a as anObject, K as functionCall, A as functionBindContext, U as getDefaultExportFromCjs, S as createCommonjsModule, Q as commonjsGlobal } from './common/object-create-d35021d9.js';
import { i as iterateSimple, f as functionUncurryThisAccessor, a as mapHelpers, m as mapIterate } from './common/map-iterate-5ecdf21b.js';
import { a as asyncIteratorIteration } from './common/async-iterator-iteration-3d6321e8.js';
    ...
    const Point3dInputPlugin = {
      ...
      controller: args => {
        ...
        return new PointNdTextController(args.document, {
          assembly: Point3dAssembly,
          axes: [createAxis$2(value.rawValue.x, c.components[0]), createAxis$2(value.rawValue.y, c.components[1]), createAxis$2(value.rawValue.z, c.components[2])],
          parser: parseNumber,
          value: value,
          viewProps: args.viewProps
        });
