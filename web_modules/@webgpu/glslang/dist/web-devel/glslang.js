var Module = function() {
    ...
    return function(Module) {
        ...
        var E, ea = new WebAssembly.Table({
            initial: 859,
            maximum: 859,
            element: "anyfunc"
        }), fa = !1;
        ...
        function aa(a) {
            var b = "string number boolean number number number".split(" "), d = {
                string: function(a) {
                    var b = 0;
        ...
        c.wasmMemory ? E = c.wasmMemory : E = new WebAssembly.Memory({
            initial: na / 65536
        });
        E && (J = E.buffer);
        na = J.byteLength;
        ...
        function Da(a, b, d, e) {
            ...
            m = {
                ...
                "%U": function(a) {
                    var b = new Date(a.A + 1900, 0, 1), d = 0 === b.getDay() ? b : X(b, 7 - b.getDay());
                    a = new Date(a.A + 1900, a.B, a.C);
                    return 0 > h(d, a) ? f(Math.ceil((31 - d.getDate() + (T(S(a.getFullYear()) ? U : W, a.getMonth() - 1) - 31) + a.getDate()) / 7), 2) : 0 === h(d, b) ? "01" : "00";
                },
                "%V": function(a) {
                    var b = n(new Date(a.A + 1900, 0, 4)), d = n(new Date(a.A + 1901, 0, 4)), e = X(new Date(a.A + 1900, 0, 1), a.G);
                ...
                "%W": function(a) {
                    var b = new Date(a.A, 0, 1), d = 1 === b.getDay() ? b : X(b, 0 === b.getDay() ? 1 : 7 - b.getDay() + 1);
                    a = new Date(a.A + 1900, a.B, a.C);
                    return 0 > h(d, a) ? f(Math.ceil((31 - d.getDate() + (T(S(a.getFullYear()) ? U : W, a.getMonth() - 1) - 31) + a.getDate()) / 7), 2) : 0 === h(d, b) ? "01" : "00";
                },
                "%y": function(a) {
        ...
        function Z() {
            function a() {
                if (!Y && (Y = !0, !fa)) {
                    ...
                    if (c.postRun) for("function" == typeof c.postRun && (c.postRun = [
                        c.postRun
                    ]); c.postRun.length;){
            ...
            if (!(0 < L)) {
                if (c.preRun) for("function" == typeof c.preRun && (c.preRun = [
                    c.preRun
                ]); c.preRun.length;)sa();
                K(oa);
        ...
        c.run = Z;
        if (c.preInit) for("function" == typeof c.preInit && (c.preInit = [
            c.preInit
        ]); 0 < c.preInit.length;)c.preInit.pop()();
        Z();
        return Module;
    };
}();
